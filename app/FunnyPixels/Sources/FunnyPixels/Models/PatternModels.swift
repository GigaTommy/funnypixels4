...
/// 图案统计信息
public struct PatternStatistics: Codable {
...
/// 创建图案请求
public struct CreatePatternRequest: Codable {
    let name: String
...
/// 更新图案请求
public struct UpdatePatternRequest: Codable {
...
/// 图案列表响应
public struct PatternsResponse: Codable {
...
/// 图案详情响应
public struct PatternDetailResponse: Codable {
    public let success: Bool
    public let data: Pattern?
...
/// 图案统计响应
public struct PatternStatisticsResponse: Codable {
    public let success: Bool
...
/// 应用图案到区域请求
public struct ApplyPatternRequest: Codable {
...
/// 应用图案响应
public struct ApplyPatternResponse: Codable {
    public let success: Bool
...
/// 已应用的图案信息
public struct AppliedPatternInfo: Codable {
