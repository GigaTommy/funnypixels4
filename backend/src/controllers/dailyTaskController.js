...
const TASK_TEMPLATES = [
  { type: 'draw_pixels', title: '像素画家', titleEn: 'Pixel Painter', titleEs: 'Pintor de Píxeles', titleJa: 'ピクセルペインター', titleKo: '픽셀 화가', titlePt: 'Pintor de Pixels', description: '绘制像素', descriptionEn: 'Draw pixels', descriptionEs: 'Dibuja píxeles', descriptionJa: 'ピクセルを描画', descriptionKo: '픽셀 그리기', descriptionPt: 'Desenhe pixels', target: 50, reward: 5 },
  ...
  { type: 'draw_sessions', title: '多次创作', titleEn: 'Multiple Sessions', titleEs: 'Múltiples Sesiones', titleJa: '複数のセッション', titleKo: '여러 세션', titlePt: 'Múltiplas Sessões', description: '完成多次绘画', descriptionEn: 'Complete multiple sessions', descriptionEs: 'Completa múltiples sesiones', descriptionJa: '複数の描画を完了', descriptionKo: '여러 번 그리기', descriptionPt: 'Complete múltiplas sessões', target: 3, reward: 10 },
  ...
  { type: 'explore_map', title: '探索地图', titleEn: 'Map Explorer', titleEs: 'Explorador del Mapa', titleJa: 'マップ探索', titleKo: '지도 탐험', titlePt: 'Explorador de Mapa', description: '在地图上活动', descriptionEn: 'Be active on the map', descriptionEs: 'Sé activo en el mapa', descriptionJa: 'マップで活動', descriptionKo: '지도에서 활動', descriptionPt: 'Seja ativo no mapa', target: 1, reward: 5 },
];
