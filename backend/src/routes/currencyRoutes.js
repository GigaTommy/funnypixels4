...
router.post('/achievements/:achievementId/claim', CurrencyController.claimAchievementReward);

// 签到相关
router.post('/checkin', CurrencyController.dailyCheckin);
...
router.post('/checkin/recover', CurrencyController.recoverStreak);
